...
const ProblemList = () => {
  ...
  const fetchProblems = async (userId, isInitial = false) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/users/problems/${userId}`,
        {
  ...
  const handleDeleteProblem = async () => {
    ...
    try {
      await axios.delete(
        `http://localhost:5000/users/problems/${userId}/${problemToDelete}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
                  ...
                  {problems.map((problem) => (
                    <li
                      ...
                      style={{
                        width: "300px",
                        padding: "20px",
                        backgroundColor: problem.resolved
                          ? "#d4edda"
                          : "#fff9c4",
                      ...
                      <div style={{ marginTop: "15px" }}>
                        ...
                        >
                          ...
                          <span>
                            <strong>End:</strong>{" "}
                            {problem.endDate
                              ? new Date(problem.endDate).toLocaleDateString()
                              : "Still now"}
                          </span>
                        </div>
                        <p
                        ...
                        >
                          ...
                          {getSatisfactionEmoji(problem.satisfaction)}
                        </p>
                        <p
                          style={{
                            margin: "8px 0",
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "50px",
                      backgroundColor:
                        currentPage === totalPages ? "#ccc" : "#0ea5e6",
                      color: "white",
                      border: "none",
                      cursor:
