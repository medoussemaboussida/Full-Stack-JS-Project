              ...
              <div className="col-lg-6">
                <div className="about-right wow fadeInUp" data-wow-delay=".25s">
                  ...
                  <p className="about-text">
                    ...
                    humour randomised words look even. Many desktop packages and
                    web page editors now their default model text.
                  </p>
              ...
              <div className="testimonial-item">
                ...
                <div className="testimonial-quote">
                  <p>
                    ...
                    have suffered of the alteration in some form by injected
